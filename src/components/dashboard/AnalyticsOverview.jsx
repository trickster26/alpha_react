        ...
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="bg-neutral-800 p-6 rounded-xl border border-neutral-700">
            <div className="animate-pulse">
              <div className="h-4 bg-neutral-700 rounded w-24 mb-4"></div>
              <div className="h-8 bg-neutral-700 rounded w-32 mb-3"></div>
  ...
  if (!analytics) {
    return (
      <div className="bg-neutral-800 rounded-xl border border-neutral-700 p-6">
        <p className="text-neutral-400 text-center">No analytics data available</p>
      </div>
    );
  }
